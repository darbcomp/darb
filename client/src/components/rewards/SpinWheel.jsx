...
export default function SpinWheel({ onClose }) {
  ...
  const guestMutation = useMutation({
    mutationFn: () => claimGuestOrderSpin({ orderNumber: orderNumber.trim().toUpperCase(), phone: phone.trim() }),
    onSuccess: (response) => {
