...
const fallbackCategoryDescriptions = {
  men: "Distinctive fragrances shaped with depth, presence and character.",
  women:
    "Expressive fragrances made to leave a graceful and memorable trail.",
  unisex:
    "Balanced fragrances created to be worn beyond labels and boundaries.",
  musk:
    "Warm, intimate musk compositions made to stay close to the skin.",
};
        ...
        <section className="border-b border-darb-gold/20">
          <div className="mx-auto max-w-7xl px-5 py-8 sm:px-6 sm:py-10 lg:px-8">
            ...
            <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <h1 className="font-display text-4xl capitalize text-darb-green sm:text-5xl">
                  {categoryName}
                </h1>
                    ...
                    {availabilityOptions.map(
                      (
                        ...
                        >
                          <input
                            type="checkbox"
                            checked={draftAvailability.includes(
                              option.value
                            )}
                            onChange={() =>
                              toggleAvailability(
