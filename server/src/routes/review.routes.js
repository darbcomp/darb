...
router.post("/admin", protect, requireAdmin, uploadReviewImage, createAdminReview);
router.patch("/admin/:id", protect, requireAdmin, uploadReviewImage, updateAdminReview);
